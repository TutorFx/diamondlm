CREATE TYPE "public"."provider" AS ENUM('github', 'token');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "chunk" ADD CONSTRAINT "chunk_guide_id_guides_id_fk" FOREIGN KEY ("guide_id") REFERENCES "public"."guides"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
